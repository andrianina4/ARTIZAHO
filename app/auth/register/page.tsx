    ...
    <div className='min-h-screen bg-bg-register bg-cover flex flex-col'>
      ...
      <main className='flex-1 py-7 px-24 flex justify-between gap-x-5 w-full max-w-page mx-auto'>
        <div className='text-white mt-20'>
          <h1 className='font-moonGet font-extrabold text-4xl leading-relaxed'>CREATE YOUR ACCOUNT<br />AND JOIN US</h1>
          <p className='font-normal mt-5'>Please fill in all fields and confirm your registration.</p>
        </div>

        <div className='flex-1 bg-white rounded-3xl pt-12 pb-24 px-11 relative'>
          <div className='flex justify-between items-center'>
            <h4 className='text-brown text-base font-extrabold mb-6'>Join us</h4>
            <div className='flex gap-x-2'>
              <span className='text-black-60%'>Already a member?</span>
              <button onClick={redirectLogin} className='text-sm font-extrabold text-bronze hover:text-opacity-70' type='button'>Sign in</button>
            </div>
          </div>
